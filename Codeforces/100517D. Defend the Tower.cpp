...
/*
The total number of configurations is small enough (4 ^ 10) that we can try all
of them and simulate what happens in each. The time limit is a bit tight though,
so some optimisations are needed.
*/
