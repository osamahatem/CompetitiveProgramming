...
public:
	string simulate(vector <int> preference1, vector <int> preference2) {
		...
		int chosen[55];
		for(i=0;i<=preference1.size();i++)
            chosen[i]=0;
		for(i=1;i<=preference1.size();i++){
            if(i%2){
                while(chosen[preference1[first]])
                    first++;
                chosen[preference1[first]]=1;
            }else{
                while(chosen[preference2[second]])
                    second++;
                chosen[preference2[second]]=2;
            }
		}
		string ans="";
		char c;
