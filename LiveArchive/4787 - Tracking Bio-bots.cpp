...
/*
This is a simple flood fill problem, but the grid is too big to store. We can
use grid compression, solve the problem normally, and then output the actual
count of unvisited cells in the original grid, excluding walls.
*/
