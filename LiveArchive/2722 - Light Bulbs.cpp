...
/*
The solution is a simple DP, where the state is the index of the switch and 3
booleans or a mask to keep track of the state of the bulbs affected by that
switch. Implemented some helper functions to handle input and output format
requirements.
*/
