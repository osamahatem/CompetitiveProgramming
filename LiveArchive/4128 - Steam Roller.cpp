...
/*
Use Dijkstra's to compute the least cost. State is coordinates and direction of
last move, with a fifth direction added that means that the last edge's cost was
doubled and I can change directions or stop.
*/
