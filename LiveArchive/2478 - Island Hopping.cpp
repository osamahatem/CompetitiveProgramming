...
/*
The solution is simply building an MST using Prim's, and keeping track of the
maximum weight edge on the path from the root to each node. This will be the
minimum we can achieve because the MST will ensure that the maximum weight is
the least possible.
*/
